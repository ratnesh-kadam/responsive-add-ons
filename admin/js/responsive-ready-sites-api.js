	...
	ResponsiveSitesAPI = {
		...
		_api_request: function( args, callback ) {
			...
			var data = [{items:[
				...
				{id: 3, responsive_site_url: "https://ccdemos.cyberchimps.com/", featured_image_url: "https://websitedemos.net/wp-content/uploads/2019/06/learn-dash-featured-image.jpg", link: "https://websitedemos.net/blog/astra-site/ecourse-3/", wpforms_path: "https://websitedemos.net/wp-content/uploads/astra-sites/457/wpforms.json", xml_path: "https://websitedemos.net/wp-content/uploads/astra-sites/457/wxr.xml", slug: "testthree", status: "publish",name: "Test Three", required_plugins: [{"slug":"elementor","init":"elementor\/elementor.php","name":"Elementor"},{"slug":"woocommerce","init":"woocommerce\/woocommerce.php","name":"WooCommerce"},{"slug":"wpforms-lite","init":"wpforms-lite\/wpforms.php","name":"WPForms Lite"}]}
				]}];
