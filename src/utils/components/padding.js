...
export default function Padding( props ) {
	...
	return (
		<Fragment>
			{ paddingEnable && (
				<RangeControl
					label={ paddingTitle ? paddingTitle : __( 'Padding', 'responsive-blocks' ) }
			...
			{ paddingEnableTop && (
				<RangeControl
					label={ __( 'Padding Top', 'responsive-blocks' ) }
					value={ paddingTop }
					min={ paddingTopMin }
					max={ paddingTopMax }
			...
			{ paddingEnableRight && (
				<RangeControl
					label={ __( 'Padding Right', 'responsive-blocks' ) }
					value={ paddingRight }
					min={ paddingRightMin }
					max={ paddingRightMax }
			...
			{ paddingEnableBottom && (
				<RangeControl
					label={ __( 'Padding Bottom', 'responsive-blocks' ) }
					value={ paddingBottom }
			...
			{ paddingEnableLeft && (
				<RangeControl
					label={ __( 'Padding Left', 'responsive-blocks' ) }
					value={ paddingLeft }
					min={ paddingLeftMin }
					max={ paddingLeftMax }
			...
			{ paddingEnableVertical && (
				<RangeControl
					label={ __( 'Padding Vertical', 'responsive-blocks' ) }
			...
			{ paddingEnableHorizontal && (
				<RangeControl
					label={ __( 'Padding Horizontal', 'responsive-blocks' ) }
