...
export default function MarginSettings( props ) {
	...
	return (
		<Fragment>
			{ marginEnableTop && (
				<RangeControl
					label={ marginTopLabel ? marginTopLabel : __( 'Margin Top', 'responsive-blocks' ) }
					value={ marginTop }
					min={ marginTopMin }
					max={ marginTopMax }
			...
			{ marginEnableRight && (
				<RangeControl
					label={ marginRightLabel ? marginRightLabel : __( 'Margin Right', 'responsive-blocks' ) }
					value={ marginRight }
					min={ marginRightMin }
					max={ marginRightMax }
			...
			{ marginEnableBottom && (
				<RangeControl
					label={ marginBottomLabel ? marginBottomLabel : __( 'Margin Bottom', 'responsive-blocks' ) }
					value={ marginBottom }
					min={ marginBottomMin }
					max={ marginBottomMax }
			...
			{ marginEnableLeft && (
				<RangeControl
					label={ marginLeftLabel ? marginLeftLabel : __( 'Margin Left', 'responsive-blocks' ) }
					value={ marginLeft }
					min={ marginLeftMin }
					max={ marginLeftMax }
			...
			{ marginEnableVertical && (
				<RangeControl
					label={ marginVerticalLabel ? marginVerticalLabel : __( 'Margin Vertical', 'responsive-blocks' ) }
			...
			{ marginEnableHorizontal && (
				<RangeControl
					label={ marginHorizontalLabel ? marginHorizontalLabel : __( 'Margin Horizontal', 'responsive-blocks' ) }
