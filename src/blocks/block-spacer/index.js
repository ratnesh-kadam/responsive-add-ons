...
class ABSpacerBlock extends Component {
	...
	render() {
		...
		return [
			...
			<Spacer { ...this.props }>
				<Resizable
					className={ classnames( className, 'ra-spacer-handle' ) }
					style={ {
					...
					minHeight= { '100%' }
					handleClasses={ {
						bottomLeft: 'ra-spacer-control__resize-handle',
					} }
...
registerBlockType( 'responsive-blocks/ra-spacer', {
	...
	keywords: [
		__( 'spacer', 'responsive-blocks' ),
		__( 'divider', 'responsive-blocks' ),
