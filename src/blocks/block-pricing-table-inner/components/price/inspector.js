	...
	render() {
		...
		<InspectorControls key="inspector">
			<PanelBody title={ __( 'Text Settings', 'responsive-blocks' ) }>
				...
				/>
				<ToggleControl
					label={ __( 'Show currency symbol', 'responsive-blocks' ) }
					checked={ showCurrency }
					onChange={ () => this.props.setAttributes( { showCurrency: ! showCurrency } ) }
				/>
				{ showCurrency && (
					<TextControl
						label={ __( 'Currency Symbol', 'responsive-blocks' ) }
						type="text"
						value={ currency }
				...
				<ToggleControl
					label={ __( 'Show pricing duration', 'responsive-blocks' ) }
					checked={ showTerm }
					onChange={ () => this.props.setAttributes( { showTerm: ! showTerm } ) }
				/>
				{ showTerm && (
					<TextControl
						label={ __( 'Pricing Duration', 'responsive-blocks' ) }
						type="text"
						value={ term }
