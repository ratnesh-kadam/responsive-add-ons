/**
 * BLOCK: Responsive Blocks Pricing Table - Price Component
 */
...
// Register the block
registerBlockType( 'responsive-blocks/ra-pricing-table-price', {
	title: __( 'Product Price', 'responsive-blocks' ),
	description: __( 'Adds a product price component with schema markup.', 'responsive-blocks' ),
	icon: 'cart',
	category: 'responsive-blocks',
	parent: [ 'responsive-blocks/ra-pricing-table' ],
	keywords: [
		__( 'pricing table', 'responsive-blocks' ),
		__( 'price', 'responsive-blocks' ),
	...
	save: function( props ) {
		...
		const wrapperClassName = classnames( {
			...
			'ra-pricing-table-price-wrap': true,
			[ textClass ]: textClass,
			[ backgroundClass ]: backgroundClass,
			'ra-pricing-has-currency': showCurrency && currency,
		} );

		// Setup class names
		const className = classnames( {
			'ra-pricing-table-price': true,
				...
				<div itemProp="offers" itemScope itemType="http://schema.org/Offer">
					{ currency && showCurrency && (
						<RichText.Content
							...
							value={ currency }
							className="ra-pricing-table-currency"
					...
					{ term && showTerm && (
						<RichText.Content
							tagName="span"
							value={ term }
							className="ra-pricing-table-term"
							style={ termStyles }
						/>
					) }
				</div>
