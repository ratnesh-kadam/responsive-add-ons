/**
 * BLOCK: Responsive Blocks Pricing Table - Button Component
 */
...
// Register the block
registerBlockType( 'responsive-blocks/ra-pricing-table-button', {
	title: __( 'Product Button', 'responsive-blocks' ),
	description: __( 'Adds a product button component.', 'responsive-blocks' ),
	icon: 'cart',
