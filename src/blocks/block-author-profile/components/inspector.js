...
export default class Inspector extends Component {
	...
	render() {
		...
		const profileAvatarShapeOptions = [
			...
			{ value: 'round', label: __( 'Round', 'responsive-blocks' ) },
		];
		...
		<InspectorControls key="inspector">
			<PanelBody>
				...
				<SelectControl
					label={ __( 'Avatar Shape', 'responsive-blocks' ) }
					description={ __( 'Choose between a round or square avatar shape.', 'responsive-blocks' ) }
				...
				<PanelColorSettings
					title={ __( 'Social Link Color', 'responsive-blocks' ) }
					initialOpen={ false }
						colorSettings={ [ {
						value: profileLinkColor,
						onChange: onChangeSocialLinkColor,
						label: __( 'Social Link Color', 'responsive-blocks' ),
					} ] }
				>
				</PanelColorSettings>
			</PanelBody>

			<PanelBody title={ __( 'Social Links', 'responsive-blocks' ) } initialOpen={ false }>
				<p>{ __( 'Add links to your social media site and they will appear in the bottom of the profile box.', 'responsive-blocks' ) }</p>

				<TextControl
					label={ __( 'Twitter URL', 'responsive-blocks' ) }
					type="url"
					value={ twitter }
				...
				<TextControl
					label={ __( 'Facebook URL', 'responsive-blocks' ) }
					type="url"
					value={ facebook }
				...
				<TextControl
					label={ __( 'Instagram URL', 'responsive-blocks' ) }
					type="url"
					value={ instagram }
				...
				<TextControl
					label={ __( 'Pinterest URL', 'responsive-blocks' ) }
					type="url"
					value={ pinterest }
				...
				<TextControl
					label={ __( 'Google URL', 'responsive-blocks' ) }
					type="url"
					value={ google }
				...
				<TextControl
					label={ __( 'YouTube URL', 'responsive-blocks' ) }
					type="url"
					value={ youtube }
				...
				<TextControl
					label={ __( 'Github URL', 'responsive-blocks' ) }
					type="url"
					value={ github }
				...
				<TextControl
					label={ __( 'LinkedIn URL', 'responsive-blocks' ) }
					type="url"
					value={ linkedin }
				...
				<TextControl
					label={ __( 'Email URL', 'responsive-blocks' ) }
					help={ __( 'Supports a URL or an email link. Email links must be prefixed with "mailto:". Example: mailto:test@example.com', 'responsive-blocks' ) }
					type="url"
					value={ email }
				...
				<TextControl
					label={ __( 'Website URL', 'responsive-blocks' ) }
					type="url"
					value={ website }
