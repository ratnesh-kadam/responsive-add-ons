			...
			<Fragment>
				...
				>
					...
					{	/* If we don't have the selected image size, show a warning */
						...
						<Fragment>
							<div className={ 'ra-post-grid-no-image-icon' }>
								<Dashicon
									icon={ 'warning' }
								/>
							</div>
							...
							<Placeholder
								className={ 'ra-post-grid-no-image-placeholder' }
							>
								<Dashicon icon={ 'info' } />
								<div className="components-placeholder__label">
									{ __( 'There is no image generated for the selected image size, so a fallback image size is being used.', 'responsive-blocks' ) }
								</div>
								<div className="ra-post-grid-image-help"><a target="_blank" rel="noreferrer noopener" aria-label={ __( 'Learn more about image sizes (opens in a new tab)', 'responsive-blocks' ) } href="https://github.com/studiopress/responsive-blocks/wiki/Post-Grid-Block#featured-image-sizes">{ __( 'Learn more ', 'responsive-blocks' ) }<span>&rarr;</span></a></div>
							</Placeholder>
						</Fragment>
					}
				</div>
