...
export default class Inspector extends Component {
	...
	render() {
		...
		const citeAlignOptions = [
			{ value: 'left-aligned', label: __( 'Left Aligned', 'responsive-blocks' ) },
			{ value: 'right-aligned', label: __( 'Right Aligned', 'responsive-blocks' ) },
		];
		...
		<InspectorControls key="inspector">
			<PanelBody>
				...
				<SelectControl
					label={ __( 'Cite Alignment', 'responsive-blocks' ) }
					description={ __( 'Left or right align the cite name and title.', 'responsive-blocks' ) }
