...
export default class Inspector extends Component {
	...
	render() {
		...
		const buttonStyleOptions = [
			{ value: 'ra-share-icon-text', label: __( 'Icon and Text' ) },
			{ value: 'ra-share-icon-only', label: __( 'Icon Only' ) },
			{ value: 'ra-share-text-only', label: __( 'Text Only' ) },
		];

		// Button shape values
		const buttonShapeOptions = [
			{ value: 'ra-share-shape-square', label: __( 'Square' ) },
			{ value: 'ra-share-shape-rounded', label: __( 'Rounded Square' ) },
			{ value: 'ra-share-shape-circular', label: __( 'Circular' ) },
		];

		// Button size values
		const shareButtonSizeOptions = [
			{ value: 'ra-share-size-small', label: __( 'Small' ) },
			{ value: 'ra-share-size-medium', label: __( 'Medium' ) },
			{ value: 'ra-share-size-large', label: __( 'Large' ) },
		];

		// Button color values
		const shareButtonColorOptions = [
			{ value: 'ra-share-color-standard', label: __( 'Standard' ) },
			{ value: 'ra-share-color-social', label: __( 'Social Colors' ) },
		];
